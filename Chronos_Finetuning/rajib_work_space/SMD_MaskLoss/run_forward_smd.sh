...
CHECKPOINT="${CHECKPOINT:-/mnt/c/Files/MTP Code Local Files/SB_dir/TSFM-anomaly/Chronos_Finetuning/rajib_work_space/SMD_MaskLoss/chronos2-single-stage_SMD_maskLoss_v1/finetuned-ckpt}" # The fine-tuned model
