...
OUTPUT_DIR="${OUTPUT_DIR:-${SCRIPT_DIR}/chronos2-single-stage_SMD_maskLoss_v1}"
...
TEST_DATA="${TEST_DATA:-/mnt/c/Files/MTP Code Local Files/SB_dir/TSFM-anomaly/Chronos_Finetuning/rajib_work_space/SMD_MaskLoss/prepared_50_50/EVAL_TEST.pkl}"
# Model
