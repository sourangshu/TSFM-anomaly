...
#
# NOTE: test sets are UNCAPPED — the per-dataset cap only ever touched TRAIN. So
...
CHECKPOINT="${CHECKPOINT:-${SCRIPT_DIR}/chronos2-single-stage_mtsbench_maskLossv2_v1/finetuned-ckpt}"
...
echo "======================================================"
echo "  mTSBench Chronos-2 Anomaly Evaluation (maskloss_v2, per dataset)"
echo "  MODE              = ${MODE}"
