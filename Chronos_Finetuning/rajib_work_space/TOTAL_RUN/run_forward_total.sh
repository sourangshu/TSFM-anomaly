...
# them into results/ALL_results.csv.
#
# Usage:
...
CHECKPOINT="${CHECKPOINT:-${SCRIPT_DIR}/chronos2-single-stage_TOTAL_v1/finetuned-ckpt}"
DEVICE="${DEVICE:-cuda}"
...
echo "======================================================"
echo "  mTSBench Chronos-2 Anomaly Evaluation (per dataset)"
echo "  MODE              = ${MODE}"
